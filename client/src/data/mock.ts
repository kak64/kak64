...
export const MOCK_EVENTS: CalendarEvent[] = [
  ...
  { id: uid('ev'), title: 'תשלום ארנונה', start: inDays(4), source: 'local', color: 'indigo' },
];

export const MOCK_FINANCE: FinancePortfolio = {
  totalValue: 482300,
...
export const MOCK_DOCUMENTS: FamilyDocument[] = [
...
export const MOCK_PASSWORDS: VaultPassword[] = [
