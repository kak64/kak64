...
--==============================================================--
-- כל פרק זמן השרת מפרסם קוד אקראי בצ'אט לעובדי מד"א המחוברים.
-- העובד מקליד /pc <קוד> ומקבל משכורת לפי דרגתו (מנגנון אנטי-AFK).
Config.Salary = {
    enabled  = true,
    interval = 15,        -- מספר הדקות בין כל חלוקת משכורת
    account  = 'bank',    -- לאיזה חשבון מועבר השכר: 'bank' או 'money'
    codeMin  = 1000,      -- הקוד האקראי המינימלי
    codeMax  = 9999,      -- הקוד האקראי המקסימלי

    -- סכום המשכורת לכל דרגה (חייב להתאים למספר הדרגות שב-Config.Uniforms)
    amounts = {
        -- זוטרים
        [0]  = 50,    -- מתלמד
        [1]  = 75,    -- חובש
